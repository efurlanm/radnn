! *** jn_rrtmgp_rfmip_lw.f90 ***
! This file was generated by the Notebook `jn_rrtmgp_rfmip_lw.ipynb`, 
...
integer            :: nargs, ncol, nlay, nbnd, ngpt, nexp, nblocks, block_size, &
                    forcing_index, physics_index, n_quad_angles = 1
logical            :: top_at_1
integer            :: b, icol, ilay, ibnd, igpt, count_rate, iTime1, iTime2, &
                    iTime3, ncid, ninputs, istat, igas, ret, i
...
print *, "Usage: rrtmgp_rfmip_lw [block_size] [rfmip_file] &
         &[k-distribution_file] [forcing_index (1,2,3)] &
         &[physics_index (1,2)]  input_output file]"

print *, "OR:  rrtmgp_rfmip_lw [block_size] [rfmip_file] &
         &[k-distribution_file] [forcing_index] [physics_index] &
         &[NN_lw_abs_file] [NN_lw_planck_file]"
