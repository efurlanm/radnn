...
This page contains my personal random notes on different subjects.
...
* **Neural Fortran** - The NN inference and I/O code in RRTGMP-NN is based on Neural-Fortran  [[Cur19](references.md#Cur19)].
...
* [JupyterLab](https://jupyter.org/) (JL) was used for most of the files in the repository, both for viewing and working on them.

* The TOC for Markdown and Notebook files can be viewed in JL using the "View > Table of Contents" menu item or by pressing Ctrl+Shift+K.
