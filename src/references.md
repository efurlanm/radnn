...
<a name="Ukk22"></a>**[Ukk22]**: Ukkonen, P., et al. (Dec 8, 2022). "peterukk/rte-rrtmgp-nn: 2.0" [Code]. (includes NN training). <https://doi.org/10.5281/zenodo.7413935> (redirects to <https://zenodo.org/records/7413935>). (repository mentioned in the Paper [[Ukk23](#Ukk23)]).
...
<a name="Ukk21"></a>**[Ukk21]**: Ukkonen, P. (2021). Training and evaluation data for machine learning models emulating the RTE+RRTMGP radiation scheme or its components [Repository]. (repository cited in the article [[Ukk22c](#Ukk22c)])

- Versions
    - ③<https://doi.org/10.5281/zenodo.5833494>
    - ②<https://doi.org/10.5281/zenodo.5564314>
    - ①<https://doi.org/10.5281/zenodo.5513435>
- Excerpt from the repository text: "The Fortran program and instructions (...) can be found at Ⓐ".
