...
num_epochs = 5000 # Updated from 50000
...
# Create a new instance of PINN for inference and load the trained weights
inference_pinn = PINN(layers).to(device)
inference_pinn.load_state_dict(model.state_dict())
inference_pinn.eval()

# Save the trained inference network
inference_net_filename = "examples/fortran/burgers/burgers_inference_trained.pt"
...
output_filename = "examples/fortran/burgers/burgers1d_python_original_results.bin"
