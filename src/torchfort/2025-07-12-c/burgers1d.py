...
torch.jit.script(model).save(inference_net_filename)
...
'''# Save the trained model for Fortran
    torch.jit.script(model).save("examples/fortran/burgers03/burgers_model_trained.pt")
    print("Trained model saved to examples/fortran/burgers03/burgers_model_trained.pt")
