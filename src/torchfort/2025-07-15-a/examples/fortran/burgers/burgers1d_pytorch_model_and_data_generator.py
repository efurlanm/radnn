...
# Save XT_tensor to a binary file for debugging
with open("python_xt_tensor.bin", 'wb') as f:
    f.write(XT_tensor.cpu().numpy().astype(np.float32).tobytes())
print("Python XT_tensor saved to python_xt_tensor.bin")
