...
!======================================
  ...
  ! The variable i is useless, the repetition loop only serves to
  ! increase the size of the problem and measure the execution time.
  do i = 1, 32  !1111111111----------
#endif
